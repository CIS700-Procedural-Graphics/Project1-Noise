...
float noiseFunc_3(float in1, float in2, float in3) {
    ...
    return (cos( dot( vec3(in1, in2, in3), vec3(80.233, .9898, 50.3535))) );
}
...
void main() {
    ...
    // TO MAKE MOVE WITH UNDULATION
     ...
     float timeOffset_2 = (time / 3.0 * 17.0 + 2.0);
     float timeOffset_3 = (time / 7.0 * 15.0 + 7.0);
     float noise = overallNoiseFunc(position[0], position[1], position[2]);
     float noise_1 = smooth(position[0] + timeOffset_1, position[0] + timeOffset_2, position[0] - timeOffset_3);
     float noise_2 = smooth(position[1] - timeOffset_1, position[1] - timeOffset_2, position[1] + timeOffset_3);
     float noise_3 = smooth(position[2] + timeOffset_1, position[2] + timeOffset_2, position[2] + timeOffset_3);
     ...
     */
     ...
     // FOR TESTING
     float pixelImageHeight = 664.0;
     float height = cosInterpFunc(1.0, 664.0 - pixelImageHeight, noise_1);
